...
import { AntDesign, Ionicons, Fontisto,Entypo } from 'react-native-vector-icons'
import {  app_c, app_sp} from "globals/styles";
import styles from "./RoundedRectangleButtonStyle";
function RoundedRectangleButton() {
  return ( <View style={styles.rounded_rectangle}>
    <TouchableOpacity style={[{backgroundColor:app_c.HEX.fourth}, styles.profile_btn]}>
