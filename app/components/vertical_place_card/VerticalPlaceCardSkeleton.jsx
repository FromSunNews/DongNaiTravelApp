  ...
  return (
    <View {...props} style={containerStyle}>
      ...
      <View style={styles.card_mid}>
        <View style={[styles.card_ske_bg, app_sh.rounded_4, { height: 15, width: '50%' }]}></View>
      </View>

      {/* Content */}
      <View style={styles.card_content_container}>
        <View style={[styles.card_ske_bg, app_sp.mb_6, app_sh.rounded_4, { height: 19, width: '100%' }]}></View>

        {/* Sub-information */}
        <View style={styles.card_content_sub_information_container}>
          <View style={[styles.card_ske_bg, app_sh.rounded_4, { height: 15, width: '70%' }]}></View>
          <View style={[styles.card_ske_bg, app_sh.rounded_4, { height: 15, width: '30%' }]}></View>
        </View>
      </View>
