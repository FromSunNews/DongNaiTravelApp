...
import { AppText, MyFadeAnimatedView, MyHeader, RectangleButton, CircleButton } from 'components'
...
const PlaceDetailScreen = () => {
  ...
  return (
    <View style={{backgroundColor: app_c.HEX.ext_third, flex: 1}}>
      ...
      >
        <BottomSheetScrollView style={styles.pd_bottom_sheet_view}>
          ...
          {/* Tabs */}
          <View style={styles.pd_tab_container}>
            <RectangleButton
              isTransparent
              typeOfButton="highlight"
              style={styles.pb_tab_button_active}
            >
              {(isActive, currentLabelStyle) => (
                <AppText style={currentLabelStyle} weight="lighter" font="h5">About</AppText>
              )}
            </RectangleButton>
            <RectangleButton
                isTransparent
              ...
              >
                {(isActive, currentLabelStyle) => (
                  <AppText style={currentLabelStyle} weight="lighter" font="h5">Reviews</AppText>
                )}
            </RectangleButton>
          </View>
